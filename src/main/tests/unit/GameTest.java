...
public class GameTest {
    ...
    public void scenarioLoading() {
        ...
        Assert.assertEquals((double) 40, game.getAgriculturePercentage(), 0);
        Assert.assertEquals(35.0, game.getIndustryPercentage(), 0);
        Assert.assertEquals(700, game.getTreasury(), 0);
        Assert.assertEquals(500, game.getFoodUnits(), 0);
